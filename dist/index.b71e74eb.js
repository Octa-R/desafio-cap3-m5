...
(()=>{
    ...
    (0, _header.header)(mainContainer);
    (0, _nav.nav)(mainContainer);
    (0, _main.main)(mainContainer);
    const inboxBtn = document.querySelector(".nav__inbox-btn");
    const sentBtn = document.querySelector(".nav__sent-btn");
    inboxBtn.addEventListener("click", ()=>(0, _goTo.goTo)("/inbox"));
    sentBtn.addEventListener("click", ()=>(0, _goTo.goTo)("/sent"));
    window.addEventListener("load", ()=>{
        (0, _handleRoute.handleRoute)(location.pathname);
    });
})();
